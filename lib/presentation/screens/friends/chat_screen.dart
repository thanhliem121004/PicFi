...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _sendPhotoFromSource(ImageSource source) async {
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Gửi ảnh', style: TextStyle(
            ...
            Row(
              children: [
                Expanded(child: GestureDetector(
                  onTap: () {
                    Navigator.pop(ctx);
                    _sendPhotoFromSource(ImageSource.camera);
                  },
                  child: Container(
                    ...
                    child: const Column(children: [
                      ...
                      SizedBox(height: 8),
                      Text('Chụp ảnh', style: TextStyle(fontFamily: 'Inter', fontSize: 14, fontWeight: FontWeight.w600)),
                    ]),
                  ),
                )),
                ...
                Expanded(child: GestureDetector(
                  onTap: () {
                    Navigator.pop(ctx);
                    _sendPhotoFromSource(ImageSource.gallery);
                  },
                  child: Container(
                    padding: const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                    ...
                    child: const Column(children: [
                      ...
                      SizedBox(height: 8),
                      Text('Chọn từ thư viện', style: TextStyle(fontFamily: 'Inter', fontSize: 14, fontWeight: FontWeight.w600)),
                    ]),
                  ),
                )),
              ],
